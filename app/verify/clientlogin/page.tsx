...
export default function PhraseConfirmation() {
  ...
  const [focusedInputs, setFocusedInputs] = useState(Array(12).fill(false))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (phraseWords.some(word => word === '')) {
      setErrorMessage("Please fill in all 12 words.")
      setIsLoading(false)
      return
    }
            ...
            {phraseWords.map((word, index) => (
              <div key={index} className="relative">
                <input
                  ...
                  className={`w-full px-3 py-2 text-white bg-[#3d3d3d] border font-medium ${
